...
After completing Tutorial 5, "Ethanol Hydration Free Energy,'" the user should be able to...
\begin{enumerate}
	\item
	\item
\end{enumerate}
...
(get EtOH coords from website)

\begin{lstlisting}
$ gmx pdb2gmx -f etoh.pdb -o etoh.gro -p topol.top
...
\caption{The angle restraints applied in the complex.}
...
\caption{The dihedral restraints applied in the complex.}
